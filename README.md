...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 270 · 🔀 3.2K · 📦 47K · 📋 2.3K - 1% open · ⏱️ 29.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 4.4M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 7.1K / month):
	```
...
<details><summary><b><a href="https://github.com/dracula/mkdocs">Dracula</a></b>  - 🥈18 ·  ⭐ 59 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/512/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Dark theme for Mkdocs.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 630 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-swan) (📥 160 / month):
	```
...
- [GitHub](https://github.com/daizutabi/mkdocs-ivory) (👨‍💻 2 · 🔀 4 · 📦 79 · 📋 5 - 40% open · ⏱️ 16.06.2020)
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 8.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 870 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 87 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 56 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 42 · 🔀 100 · 📦 13K · 📋 390 - 11% open · ⏱️ 27.04.2024)
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 1.1M / month):
	```
...
- [PyPi](https://pypi.org/project/mkapi) (📥 6.5K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 10 · 🔀 9 · 📥 1K · 📦 170 · 📋 35 - 40% open · ⏱️ 01.02.2024)
...
<details><summary><b><a href="https://github.com/bruce-szalwinski/mkdocs-typer">mkdocs-typer</a></b>  - 🥉11 ·  ⭐ 27 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1459/PNG/512/2799201-jigsaw-processing_99781.png" style="display:inline;" width="13" height="13"></code><br>An MkDocs extension to generate documentation for Typer command line applications.</summary>

- [GitHub](https://github.com/bruce-szalwinski/mkdocs-typer) (🔀 1 · 📋 6 - 50% open · ⏱️ 21.06.2023)
- [PyPi](https://pypi.org/project/mkdocs-typer) (📥 7.2K / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 48 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 36 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blogging-plugin) (📥 3.7K / month):
	```
...
- [GitHub](https://github.com/mkusz/mkdocs-publisher) (👨‍💻 2 · 🔀 1 · 📥 9 · 📦 31 · 📋 13 - 30% open · ⏱️ 21.04.2024)
...
- [GitHub](https://github.com/lyz-code/mkdocs-newsletter) (👨‍💻 3 · 🔀 2 · 📦 39 · 📋 10 - 30% open · ⏱️ 25.03.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 4.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 71 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/mikitex70/plantuml-markdown) (👨‍💻 28 · 🔀 53 · 📦 1.3K · 📋 64 - 1% open · ⏱️ 24.04.2024)
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 13 · 🔀 25 · 📦 1.9K · 📋 66 - 10% open · ⏱️ 06.03.2024)
...
- [GitHub](https://github.com/blueswen/mkdocs-glightbox) (👨‍💻 4 · 🔀 14 · 📥 24 · 📦 2.5K · 📋 34 - 32% open · ⏱️ 02.05.2024)
...
- [GitHub](https://github.com/timvink/mkdocs-table-reader-plugin) (👨‍💻 8 · 🔀 17 · 📦 640 · 📋 41 - 9% open · ⏱️ 15.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 39K / month):
	```
...
- [GitHub](https://github.com/LukeCarrier/mkdocs-drawio-exporter) (👨‍💻 5 · 🔀 5 · 📦 67 · 📋 27 - 14% open · ⏱️ 23.04.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-build-plantuml-plugin) (📥 35K / month):
	```
...
<details><summary><b><a href="https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin">kroki</a></b>  - 🥈18 ·  ⭐ 38 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for Kroki-Diagrams.</summary>

- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 13 · 🔀 24 · 📦 35 · 📋 23 - 30% open · ⏱️ 21.01.2024)
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-charts-plugin) (📥 6.1K / month):
	```
...
<details><summary><b><a href="https://github.com/soulless-viewer/mkdocs-video">MkDocs Video</a></b>  - 🥈17 ·  ⭐ 65 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Video plugin.</summary>

- [GitHub](https://github.com/soulless-viewer/mkdocs-video) (👨‍💻 5 · 🔀 12 · 📥 42 · 📦 640 · ⏱️ 04.01.2024)
- [PyPi](https://pypi.org/project/mkdocs-video) (📥 60K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 20K / month):
	```
...
<details><summary><b><a href="https://github.com/landmaj/mkdocs-d2-plugin">mkdocs-d2-plugin</a></b>  - 🥈11 ·  ⭐ 10 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A plugin for embedding D2 diagrams in MkDocs.</summary>

- [GitHub](https://github.com/landmaj/mkdocs-d2-plugin) (👨‍💻 3 · 🔀 3 · 📦 3 · ⏱️ 24.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 5.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-img2fig-plugin) (📥 2.4K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 2.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/daxcore/mkdocs-obsidian-interactive-graph-plugin) (👨‍💻 2 · 📦 1 · ⏱️ 24.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 130 / month):
	```
...
<details><summary><b><a href="https://github.com/mbarkhau/markdown-aafigure">Markdown aafigure</a></b>  - 🥉7 ·  ⭐ 4 · 💤 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1459/PNG/512/2799201-jigsaw-processing_99781.png" style="display:inline;" width="13" height="13"></code><br>aafigure extension for Python Markdown.</summary>

- [GitHub](https://github.com/mbarkhau/markdown-aafigure) (🔀 1 · 📋 3 - 33% open · ⏱️ 30.04.2021)
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 86 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 74 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 24 / month):
	```
...
- [GitHub](https://github.com/fralau/mkdocs-macros-plugin) (👨‍💻 30 · 🔀 45 · 📦 3.1K · 📋 120 - 5% open · ⏱️ 28.04.2024)
...
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b>  - 🥇24 ·  ⭐ 330 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Use Jupyter Notebook in mkdocs.</summary>

- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 24 · 🔀 42 · 📦 2.3K · 📋 120 - 20% open · ⏱️ 09.04.2024)
...
- [PyPi](https://pypi.org/project/termynal) (📥 7.2K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-placeholder-plugin) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 1.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 41 / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 24 · 🔀 33 · 📦 6.5K · 📋 84 - 13% open · ⏱️ 30.04.2024)
...
- [GitHub](https://github.com/timvink/mkdocs-git-authors-plugin) (👨‍💻 10 · 🔀 16 · 📦 760 · 📋 55 - 18% open · ⏱️ 12.03.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 71K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-committers-plugin) (📥 9.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 8.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 740 / month):
	```
...
<details><summary><b><a href="https://github.com/monosans/mkdocs-minify-html-plugin">minify-html</a></b>  - 🥈17 ·  ⭐ 3 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for minification using minify-html, an extremely fast and smart HTML + JS + CSS minifier.</summary>

- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 3 · 📦 13 · ⏱️ 02.05.2024)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-extra-sass-plugin) (🔀 2 · 📦 23 · ⏱️ 13.02.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swagger-ui-tag) (📥 32K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 29 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mdpo-plugin) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-translations) (📥 19 / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 15 · 🔀 15 · 📦 340 · 📋 34 - 8% open · ⏱️ 15.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 43K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 920K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezlinks-plugin) (📥 4.2K / month):
	```
...
- [PyPi](https://pypi.org/project/autolink-references-mkdocs-plugin) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 17K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 2.8K / month):
	```
...
- [GitHub](https://github.com/realtimeprojects/mkdocs-ezglossary) (📋 15 - 6% open · ⏱️ 24.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 2.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 3.2K / month):
	```
...
- [GitHub](https://github.com/timmeinerzhagen/mkdocs-link-marker) (👨‍💻 2 · 🔀 1 · 📦 8 · 📋 4 - 50% open · ⏱️ 25.02.2024)
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-abs-rel-plugin) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 270 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 44 · 🔀 240 · 📦 31K · 📋 360 - 1% open · ⏱️ 22.04.2024)
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 3.7M / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 900 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 20K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 14 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-awesome-pages-plugin) (📥 240K / month):
	```
...
- [GitHub](https://github.com/unverbuggt/mkdocs-encryptcontent-plugin) (👨‍💻 5 · 🔀 13 · 📥 85 · 📦 1.1K · 📋 61 - 3% open · ⏱️ 13.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-encryptcontent-plugin) (📥 8.5K / month):
	```
...
- [GitHub](https://github.com/oprypin/mkdocs-literate-nav) (🔀 8 · 📦 1.7K · 📋 26 - 38% open · ⏱️ 27.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-literate-nav) (📥 200K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 43K / month):
	```
...
- [GitHub](https://github.com/shu307/mkdocs-nav-weight) (👨‍💻 3 · 🔀 2 · 📦 49 · ⏱️ 17.11.2023)
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 7.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 44 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 370 / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-spellcheck">mkdocs-spellcheck</a></b>  - 🥇16 ·  ⭐ 11 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A spell checker plugin for MkDocs.</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-spellcheck) (👨‍💻 3 · 🔀 3 · 📦 36 · 📋 18 - 55% open · ⏱️ 23.03.2024)
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 9.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 4.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 44 / month):
	```
...
- [GitHub](https://github.com/chrieke/mkdocs-exclude-search) (👨‍💻 5 · 🔀 2 · 📥 8 · 📦 370 · ⏱️ 04.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 920 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 680 / month):
	```
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 11 · 🔀 43 · 📦 900 · 📋 88 - 47% open · ⏱️ 05.10.2021)
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 73 · 📦 500 · 📋 100 - 56% open · ⏱️ 14.10.2021)
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 47K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-print-site-plugin) (👨‍💻 7 · 🔀 18 · 📦 300 · 📋 88 - 15% open · ⏱️ 10.04.2024)
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 920 / month):
	```
...
<details><summary><b><a href="https://github.com/adrienbrignon/mkdocs-exporter">mkdocs-exporter</a></b>  - 🥉13 ·  ⭐ 52 · 📈 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A plugin for MkDocs that exports your pages as PDF documents.</summary>

- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 2 · 📦 3 · 📋 19 - 15% open · ⏱️ 24.03.2024)
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 87 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 30 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 160 / month):
	```
...
- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 43 · 📥 160 · 📦 2.9K · 📋 180 - 4% open · ⏱️ 02.05.2024)
- [PyPi](https://pypi.org/project/mike) (📥 250K / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 260K / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 10 · 📦 46 · ⏱️ 28.04.2024)
- [PyPi](https://pypi.org/project/mkdocs-simple-plugin) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 4 · 🔀 6 · 📦 42 · ⏱️ 01.05.2024)
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 11K · ⏱️ 01.05.2024):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 95 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-new-features-notifier) (📥 760 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 13 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 15 · 🔀 18 · 📥 200 · 📦 2K · 📋 72 - 4% open · ⏱️ 02.05.2024)
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 220K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 7.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-embed-external-markdown) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-include) (📥 22K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 730 / month):
	```
